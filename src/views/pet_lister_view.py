...
from .http_types.http_request import HttpRequest #pylint: disable=unused-argument
...
class PetListerView(ViewInterface):
    ...
    def handle(self, http_request: HttpRequest) -> HttpResponse: #pylint: disable=unused-argument
